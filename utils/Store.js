...
function reducer(state, action) {
    ...
    switch (action.type) {
        ...
        case 'CART_REMOVE_ITEM': {
            // const indexOfItemToRemove = state.cart.cartItems.indexOf(action.payload);
            // const cartItems = indexOfItemToRemove > -1 ? state.cart.cartItems.splice(indexOfItemToRemove, 1) : state.cart.cartItems;
